<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="可预约时间" prop="keyuyueshijian">
          <el-input v-model="ruleForm.keyuyueshijian" 
              placeholder="可预约时间" clearable  :readonly="ro.keyuyueshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="可预约时间" prop="keyuyueshijian">
              <el-input v-model="ruleForm.keyuyueshijian" 
                placeholder="可预约时间" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.jiaolianxingming = true;
          ...
          if(o=='keyuyueshijian'){
            this.ruleForm.keyuyueshijian = obj[o];
	    this.ro.keyuyueshijian = true;
            continue;
          }
          if(o=='kechengjieshao'){
	...
	this.ruleForm.kechengjieshao = this.ruleForm.kechengjieshao.replace(reg,'../../../springbootcbz46/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
