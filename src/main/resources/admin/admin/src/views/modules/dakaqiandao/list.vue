    ...
    <div v-if="showFlag">
      <el-form :inline="true" :model="searchForm" class="form-content">
        <el-row  :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                ...
                <el-form-item :label="contents.inputTitle == 1 ? '打卡图片' : ''">
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 1" prefix-icon="el-icon-search" v-model="searchForm.dakatupian" placeholder="打卡图片" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 1 && contents.inputIconPosition == 2" suffix-icon="el-icon-search" v-model="searchForm.dakatupian" placeholder="打卡图片" clearable></el-input>
                  <el-input v-if="contents.inputIcon == 0" v-model="searchForm.dakatupian" placeholder="打卡图片" clearable></el-input>
                </el-form-item>
          <el-form-item>
        ...
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
		    ...
		    label="用户姓名">
		     <template slot-scope="scope">
                  ...
                  <el-table-column :sortable="contents.tableSortable" :align="contents.tableAlign"  prop="dakatupian"
                   :header-align="contents.tableAlign"
                    width="200"
                    label="打卡图片">
                    <template slot-scope="scope">
                      <div v-if="scope.row.dakatupian">
                        <img :src="$base.url+scope.row.dakatupian.split(',')[0]" width="100" height="100">
                      </div>
                      <div v-else>无图片</div>
                    </template>
                  </el-table-column>
    ...
    getDataList() {
      ...
      let params = {
        ...
        sort: 'id',
          ...
          if(this.searchForm.dakatupian!='' && this.searchForm.dakatupian!=undefined){
            params['dakatupian'] = '%' + this.searchForm.dakatupian + '%'
          }
      this.$http({
